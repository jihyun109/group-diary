            ...
            <div class="card-body">
              ...
              <form name="userInfo" role="form" class="text-start">
                ...
                <div class="text-center">
                  <button
                    @click.prevent="requestEditeUserInfo"
                  ...
                  <button
                    type="button"
                    class="btn bg-btn-primary bg-gradient-light w-100 mb-2"
                ...
                <div
                  class="modal fade"
                  id="editeCanceleModal"
                  tabindex="-1"
                  aria-labelledby="editeCanceleModalLabel"
                  aria-hidden="true"
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="editeCanceleModalLabel">
                          회원정보 수정 취소
                        </h5>
                        <button
                          type="button"
