...
public class TeamDiaryController {
    ...
    public HashMap<String, Object> getTeamDiaries() {
        List<TeamDiaryEntity> data = teamDiaryService.getTeamDiaries();
    ...
    public HashMap<String, String> insertTeamDiary(@RequestBody TeamDiaryEntity teamDiary) {
    ...
    public HashMap<String, String> updateTeamDiary(@RequestBody TeamDiaryEntity teamDiaryData, @PathVariable(required = true) int id) {
